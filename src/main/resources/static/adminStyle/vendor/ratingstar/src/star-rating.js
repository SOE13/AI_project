   ...
   /* var Widget = function (el, options) { // HTMLElement, object|null
    ...
    Widget.prototype = {
     ...
     /*   init_: function () {
       ...
       //   alert("select"+this.getSelectedValue_());
          
         // var $select = this;
         // var selectedValue = $select.val();
          
         // alert("value ; "+selectedValue);
       //   $('#dataTable').closest('tr').find('#rating').val(0);
          
        // var $selectboxes = $('table').find('select');
         //$selectboxes.parent().next('td').find('#rating').val(this.getSelectedValue_());
          
         // alert("selectboxes : "+this.val());
          ...
          //}
    		...
    		$selectboxes.on('change', function() {
    		  ...
    		  var selectedText = $select.find('option:selected').text();
    		   ...
    		   var selectedValue = $select.val();
    		   $select.parent().next('td').find('input').val('Oh ' + selectedText + ', ' + selectedValue + '!!!' + '<br>Index: ' + $selectboxes.index(this)); 
